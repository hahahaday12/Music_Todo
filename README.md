...
#### ⭐️ 3) 시계 아이콘 hover시 등록된 날짜, 수정된 날짜 보이기.<br/>
-> 

#### ⭐️ 4) Youtube OpenApi, recoil 을 사용하여 음악 플레이리스트, 비디오 플레이리스트  노출 기능<br/>
-> 

#### ⭐️ 5) 날씨 openApi를 사용하여 현재 위치, 현재온도 를 가져오고, 현재위치에 대한 날씨 데이터에 맞는 아이콘 출력.<br/>
-> 
