...
const YOUTUBEVIDEO = `https://www.googleapis.com/youtube/v3/playlistItems?key=${VITE_APP_YOUTUBE_KEY}&playlistId=PLEjyqb6DF-9asQZVEhtqzjrPcv-H4oVkU&part=snippet&maxResults=20`;
...
export const getYoutubeVideo = async () => {
  const res = await fetch(`${YOUTUBEVIDEO}`);
  const json = await res.json();
  return json;
}
