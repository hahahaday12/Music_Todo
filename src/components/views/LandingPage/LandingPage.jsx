...
import VideomodalContent from '../components/Modal/videomodal';
import TodoResult from '../components/TodoComponents/TodoResult.jsx';
import { faMusic, faPlay, faPause, faVideo } from "@fortawesome/free-solid-svg-icons";
...
import LPplayer from '/imge/LPplayer.png'
...
function LandingPage () {
  ...
  return(
    <div className='LandingContainer'>
      ...
      <img src={LPplayer} alt='lp사진' className='lpimg'/>
      ...
      <div className='LandingContainer_right'>
        <div className='LandingContainer_ModalBox'> 
          <FontAwesomeIcon
            icon={faMusic}
            size="2x"
            color="#FD8A8A"
        ...
        <div className='VideoModal_Container'>
          <FontAwesomeIcon
            ...
            style={{marginLeft:"9px", marginTop:"10px"}}
          />
            {videoModal ? <VideomodalContent/> : null}
        </div>
      </div>
    </div>
  )
